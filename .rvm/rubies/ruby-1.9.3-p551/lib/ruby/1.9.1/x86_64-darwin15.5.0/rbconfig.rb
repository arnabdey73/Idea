...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.9.1/x86_64-darwin15.5.0")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/arnabdey73/.rvm/rubies/ruby-1.9.3-p551")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/arnabdey73/.rvm/rubies/ruby-1.9.3-p551' '--with-opt-dir=/usr/local/opt/libyaml:/usr/local/opt/readline:/usr/local/opt/libksba:/usr/local/opt/openssl' '--without-tcl' '--without-tk' '--disable-install-doc' '--enable-shared' 'CC=/usr/local/bin/gcc-4.9'"
  CONFIG["vendordir"] = "$(rubylibprefix)/vendor_ruby"
  CONFIG["sitedir"] = "$(rubylibprefix)/site_ruby"
  CONFIG["ruby_version"] = "1.9.1"
  CONFIG["sitearch"] = "$(arch)"
  CONFIG["arch"] = "x86_64-darwin15.5.0"
  ...
  CONFIG["CC"] = "/usr/local/bin/gcc-4.9"
  CONFIG["target_os"] = "darwin15.5.0"
  CONFIG["target_vendor"] = "apple"
  CONFIG["target_cpu"] = "x86_64"
  CONFIG["target"] = "x86_64-apple-darwin15.5.0"
